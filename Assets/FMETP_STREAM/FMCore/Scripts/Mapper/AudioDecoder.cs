...
namespace FMSolution.FMETP
{
    ...
    public class AudioDecoder : MonoBehaviour
    {
        ...
        {
            float[] ABuffer = FMCoreTools.Int16ToNormalizedFloatArray(inputByteData);
            ...
            CreateClip();
#else
            CreateClipWeb(FMCoreTools.FloatArrayToByteArray(ABuffer));
#endif
            await Task.Yield();
        ...
        private void CreateClipWeb(byte[] inputByteData)
        {
            ...
            {
                StreamAudio((int)label, SourceChannels, inputByteData.Length / sizeof(float), SourceSampleRate, inputByteData, inputByteData.Length);
            }
        }
