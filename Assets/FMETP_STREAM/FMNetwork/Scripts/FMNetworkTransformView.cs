...
namespace FMSolution.FMNetwork
{
    ...
    public class FMNetworkTransformView : MonoBehaviour
    {
        ...
        private void Reset()
        {
            FMNetworkManager[] _networks = FindObjectsOfType<FMNetworkManager>();
        ...
        {
            FMNetworkTransformView[] allViews = FindObjectsOfType<FMNetworkTransformView>();
        ...
        private bool IsFMNetworkExisted()
        {
            if (FMNetwork == null)
            {
                UnityEngine.Object[] managerObjects = FindObjectsOfType(typeof(FMNetworkManager));
        ...
        private void RegisterFMNetworkID()
        {
            ...
            if (IsFMNetworkExisted())
            {
                ...
                {
                    Debug.LogWarning("view id existed: " + viewID + ", " + this.gameObject.name + " will be ignored.");
                }
